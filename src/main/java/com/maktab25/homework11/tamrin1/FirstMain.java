...
public class FirstMain {
    public static void main(String[] args) {
        List<Animal> asfasf = Arrays.asList(
                ...
                new Cat("cat51", BreedType.Kurilian_Bobtail), new Cat("cat52", BreedType.Maine_Coon),
                new Cat("cat53", BreedType.Manx), new Cat("cat54", BreedType.Mekong_Bobtail),
                new Cat("cat55", BreedType.Minskin), new Cat("cat56", BreedType.Munchkin),
                new Cat("cat57", BreedType.LaPerm), new Cat("cat58", BreedType.Lykoi),
                new Cat("cat59", BreedType.Napoleon), new Cat("cat60", BreedType.Nebelung),
                new Cat("cat61", BreedType.Norwegian_Forest_Cat), new Cat("cat62", BreedType.Ocicat),
                new Cat("cat63", BreedType.Ojos_Azules), new Cat("cat64", BreedType.Oregon_Rex),
                new Cat("cat65", BreedType.Oriental_Bicolor), new Cat("cat66", BreedType.Oriental_Longhair),
                new Cat("cat67", BreedType.Oriental_Shorthair), new Cat("cat68", BreedType.Persian_Modern),
                new Cat("cat69", BreedType.Persian_Traditional), new Cat("cat70", BreedType.Peterbald),
                new Cat("cat71", BreedType.Pixie_Bob), new Cat("cat72", BreedType.Raas),
                new Cat("cat73", BreedType.Ragamuffin), new Cat("cat74", BreedType.Ragdoll),
                new Cat("cat75", BreedType.Russian_Blue), new Cat("cat76", BreedType.Russian_White),
                new Cat("cat77", BreedType.Sam_Sawet), new Cat("cat78", BreedType.Savannah),
                new Cat("cat79", BreedType.Scottish_Fold), new Cat("cat80", BreedType.Selkirk_Rex),
                new Cat("cat81", BreedType.Serengeti), new Cat("cat82", BreedType.Serrade_Petit),
                new Cat("cat83", BreedType.Siamese), new Cat("cat84", BreedType.Siberian),
                new Cat("cat85", BreedType.Singapura), new Cat("cat86", BreedType.Snowshoe),
                new Cat("cat87", BreedType.Sokoke), new Cat("cat88", BreedType.Somali),
                new Cat("cat89", BreedType.Sphynx), new Cat("cat90", BreedType.Suphalak),
                new Cat("cat91", BreedType.Ukrainian_Levkoy), new Cat("cat92", BreedType.Wila_Krungthep),
                new Cat("cat93", BreedType.YorkChocolate), new Cat("cat94", BreedType.Tonkinese),
                new Cat("cat95", BreedType.Thai_Lilac), new Cat("cat96", BreedType.Thai),
